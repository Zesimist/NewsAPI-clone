    ...
    return (
      <div>
        <Router>
          <Navbar />
          <Switch>
          <Route exact path='/business'><News key="1" pageSize={this.pageSize} country="in" category="business" /></Route>
          <Route exact path='/entertainment'><News key="2" pageSize={this.pageSize} country="in" category="entertainment" /></Route>
          <Route exact path='/general'><News key="3" pageSize={this.pageSize} country="in" category="general" /></Route>
