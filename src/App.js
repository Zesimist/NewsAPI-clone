    ...
    return (
      <div>
        ...
        progress={this.state.progress}/>
          <Switch>
          <Route exact path='/business'><News setProgress={this.setProgress} apiKey={this.apiKey} key="1" pageSize={this.pageSize} country="in" category="business" /></Route>
          <Route exact path='/entertainment'><News setProgress={this.setProgress} apiKey={this.apiKey} key="2" pageSize={this.pageSize} country="in" category="entertainment" /></Route>
          <Route exact path='/general'><News setProgress={this.setProgress} apiKey={this.apiKey} key="3" pageSize={this.pageSize} country="in" category="general" /></Route>
